...
import { fetchAllBooks, fetchAvailableBooks, getBookStats } from "../services/bookService";

export const getAllBooksController = (req: Request, res: Response): void => {
...
export const getAvailableBooksController = (req: Request, res: Response): void => {
    const books = fetchAvailableBooks();
    res.status(HTTP_STATUS.OK).json({
